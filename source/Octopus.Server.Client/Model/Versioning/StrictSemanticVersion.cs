...
namespace Octopus.Client.Model.Versioning
{
    ...
    public partial class StrictSemanticVersion
    {
        ...
        /// <param name="metadata">Build metadata</param>
        public StrictSemanticVersion(int major, int minor, int patch, IEnumerable<string> releaseLabels, string metadata)
            : this(new Version(major, minor, patch, 0), releaseLabels, metadata)
        {
        }

        protected StrictSemanticVersion(Version version, string releaseLabel = null, string metadata = null)
        ...
        protected StrictSemanticVersion(int major, int minor, int patch, int revision, IEnumerable<string> releaseLabels, string metadata)
