...
{
    public class SpaceDefaultLifecycleTentacleRetentionPolicyResource : SpaceDefaultRetentionPolicyResource
    {
        public SpaceDefaultLifecycleTentacleRetentionPolicyResource(RetentionPeriodStrategy strategy)
        {
            Strategy = strategy;
        }
