...
{
    public class RunbookRunForPublishedRunbookResource : Resource, IExecutionResource, IHaveSpaceResource, IIncludeRunbookRunRequestProperties
    {
        public RunbookRunForPublishedRunbookResource()
        {
