...
public class OctopusExceptionFactoryFixture
{
    ...
    public async Task Http400or409Response_WithNoPayLoad_ShouldCreateOctopusValidationException(HttpStatusCode statusCode)
    {
    ...
    public async Task CreatedOctopusValidationException_ShouldContainPayloadInformation(OctopusExceptionFactory.OctopusErrorsContract octopusErrorsContract)
    {
    ...
    public static IEnumerable<TestCaseData> CreatedOctopusExceptionTestData()
    {
        ...
        yield return new TestCaseData(new OctopusExceptionFactory.OctopusErrorsContract { ErrorMessage = "Error message" });
        yield return new TestCaseData(new OctopusExceptionFactory.OctopusErrorsContract { ErrorMessage = "Error message", Errors = new []{ "Additional error" }});
        yield return new TestCaseData(new OctopusExceptionFactory.OctopusErrorsContract { ErrorMessage = "Error message", Errors = new []{ "Additional error" }, HelpText = "Help text"});
        yield return new TestCaseData(new OctopusExceptionFactory.OctopusErrorsContract { ErrorMessage = "Error message", Errors = new []{ "Additional error" }, HelpText = "Help text", FullException = "Full exception"});
        yield return new TestCaseData(new OctopusExceptionFactory.OctopusErrorsContract { Errors = new []{ "Additional error" }, HelpText = "Help text"});
    }

    [Test]
    [TestCase(HttpStatusCode.Unauthorized)]
    [TestCase(HttpStatusCode.Forbidden)]
    public async Task Http401or403Response_WithNoPayLoad_ShouldCreateOctopusSecurityException(HttpStatusCode statusCode)
    {
        var httpResponseMessage = new HttpResponseMessage(statusCode);
        var createdException = await OctopusExceptionFactory.CreateException(httpResponseMessage);
    ...
    [Test]
    [TestCaseSource(nameof(CreatedOctopusExceptionTestData))]
    public async Task CreatedOctopusSecurityException_ShouldContainPayloadInformation(OctopusExceptionFactory.OctopusErrorsContract octopusErrorsContract)
    {
    ...
    [Test]
    [TestCaseSource(nameof(CreatedOctopusExceptionTestData))]
    public async Task CreatedOctopusResourceNotFoundException_ShouldContainPayloadInformation(OctopusExceptionFactory.OctopusErrorsContract octopusErrorsContract)
    {
    ...
    [Test]
    [TestCaseSource(nameof(CreatedOctopusExceptionTestData))]
    public async Task CreatedOctopusMethodNotAllowedFoundException_ShouldContainPayloadInformation(OctopusExceptionFactory.OctopusErrorsContract octopusErrorsContract)
    {
        ...
        var createdException =
            await OctopusExceptionFactory.CreateException(httpResponseMessage) as OctopusMethodNotAllowedFoundException;
    ...
    public async Task HttpResponseWithStatusCodeExcluding_400_401_403_404_405_409_AndNoPayload_ShouldCreateOctopusServerException(HttpStatusCode statusCode)
    {
        var httpResponseMessage = new HttpResponseMessage(statusCode);
        var createdException = await OctopusExceptionFactory.CreateException(httpResponseMessage);
    ...
    [Test]
    [TestCaseSource(nameof(CreatedOctopusExceptionTestData))]
    public async Task CreatedOctopusServerException_ShouldContainPayloadInformation(OctopusExceptionFactory.OctopusErrorsContract octopusErrorsContract)
    {
