        ...
        public void WhenTheNextVersionOf_IsReleasedIssue11266ShouldBeFixed()
        {
            typeof(WinHttpHandler).GetAssembly()
                ...
                .Be(new Version(4, 0, 0, 0),
                    "The Issue https://github.com/dotnet/corefx/issues/11266 should be fixed in the next release of System.Net.Http.WinHttpHandler, and the workaround (and this test) can be removed (See COREFX_ISSUE_11266_EXISTS compiler flag)");
        }
    }
}
#endif
