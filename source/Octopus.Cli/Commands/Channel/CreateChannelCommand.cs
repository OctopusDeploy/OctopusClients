...
namespace Octopus.Cli.Commands.Channel
{
    ...
    public class CreateChannelCommand : ApiCommand, ISupportFormattedOutput
    {
        ...
        {
            if (!await Repository.SupportsChannels()) throw new CommandException("Your Octopus server does not support channels, which was introduced in Octopus 3.2. Please upgrade your Octopus server to start using channels.");
