    ...
    internal class PackageBuilder : IPackageMetadata
    {
        ...
        private static bool RequiresV4TargetFrameworkSchema(ICollection<IPackageFile> files)
        {
            ...
            bool hasEmptyLibFolder = files.Any(
                f => f.TargetFramework != null &&
                     ...
                     f.EffectivePath == PackageEmptyFileName);
        ...
        private void AddFiles(string basePath, string source, string destination, string exclude = null)
        {
            ...
            if (_includeEmptyDirectories)
            {
                ...
                searchFiles.RemoveAll(file => Path.GetFileName(file.Path) == PackageEmptyFileName
    ...
    <Default Extension=""psmdcp"" ContentType=""application/vnd.openxmlformats-package.core-properties+xml"" />");
        ...
        internal sealed class EmptyFrameworkFolderFile : PhysicalPackageFile
        {
            public EmptyFrameworkFolderFile(string directoryPathInPackage)  
            {
                ...
                TargetPath = System.IO.Path.Combine(directoryPathInPackage, PackageEmptyFileName);
            }
