...
namespace Octopus.Cli.Commands
{
    ...
    public class CreateChannelCommand : ApiCommand
    {
        ...
        {
            if (!Repository.Client.RootDocument.HasLink("Channels")) throw new CommandException("Your Octopus server does not support channels, which was introduced in Octopus 3.2. Please upgrade your Octopus server to start using channels.");
