...
namespace Octopus.Cli.Commands.Releases
{
    ...
    public class DeleteReleasesCommand : ApiCommand, ISupportFormattedOutput
    {
        ...
        {
            if (ChannelNames.Any() && !await Repository.SupportsChannels()) throw new CommandException("Your Octopus server does not support channels, which was introduced in Octopus 3.2. Please upgrade your Octopus server, or remove the --channel arguments.");
